...
gsap.from("#img-con img", {
  opacity: 0,
  duration: 2,
  delay: 0,
  scrollTrigger: {
    trigger: "#img-con", // trigger element
    start: "top 70%", // start animation when 50% of the trigger element is in view
    end: "100% 50%", // end animation when 100% of the trigger element is in view
    scrub: 1, 
    // scrub the animation as the user scrolls
  }
})
gsap.from("#img-div img", {
  ...
  delay: 0,
  scrollTrigger: {
    trigger: "#img-div", // trigger element
    start: "top 70%", // start animation when 50% of the trigger element is in view
    end: "100% 50%", // end animation when 100% of the trigger element is in view
    scrub: 1, 
   // scrub the animation as the user scrolls
...
gsap.from("#uncle-div img", {
  opacity: 0,
  duration: 3,
  delay: 2,
  scrollTrigger: {
    trigger: "#uncle-div", // trigger element
    start: "top 70%", // start animation when 50% of the trigger element is in view
    end: "100% 50%", // end animation when 100% of the trigger element is in view
    scrub: 1, 
   // scrub the animation as the user scrolls
